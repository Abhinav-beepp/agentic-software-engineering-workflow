...
Design a modular URL-shortening service with an HTTP API, durable URL mapping, redirect-time analytics, validation, tests, and a documented path to higher-scale deployment.
